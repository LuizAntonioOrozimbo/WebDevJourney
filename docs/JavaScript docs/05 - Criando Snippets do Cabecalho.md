Perfeito 😎💻
Criar um snippet no VS Code vai agilizar muito sua vida — você digita uma palavrinha (como cabecalho) e ele cola automaticamente seu modelo de comentário no arquivo .js.
